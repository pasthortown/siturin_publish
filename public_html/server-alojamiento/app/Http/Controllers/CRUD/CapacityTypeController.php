...
class CapacityTypeController extends Controller
{
    ...
    function filtered(Request $data)
    {
       ...
       return response()->json(CapacityType::where('register_type_id', $register_type_id)->get(),200);
    }
    ...
    function post(Request $data)
    {
       try{
          ...
          $capacitytype->editable_beds = $result['editable_beds'];
    ...
    function put(Request $data)
    {
       try{
          ...
          $capacitytype = CapacityType::where('id',$result['id'])->update([
             ...
             'editable_beds'=>$result['editable_beds'],
