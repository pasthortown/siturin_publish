...
$router->group(['middleware' => ['auth']], function () use ($router) {
   ...
   $router->get('/propertytitleattachment/get_by_register_id', ['uses' => 'PropertyTitleAttachmentController@get_by_register_id']);
   ...
   $router->get('/authorizationattachment/get_by_register_id', ['uses' => 'AuthorizationAttachmentController@get_by_register_id']);
